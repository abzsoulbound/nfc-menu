...
const globalForDemoSimulator = globalThis as unknown as {
  __NFC_DEMO_SIM_LAST_RUN_MS__?: number
  __NFC_DEMO_SIM_SESSIONS_BY_TABLE__?: Record<number, string>
}
...
function demoSessionMap() {
  if (!globalForDemoSimulator.__NFC_DEMO_SIM_SESSIONS_BY_TABLE__) {
    globalForDemoSimulator.__NFC_DEMO_SIM_SESSIONS_BY_TABLE__ = {}
  }
  return globalForDemoSimulator.__NFC_DEMO_SIM_SESSIONS_BY_TABLE__
}
...
export function runDemoSimulatorTick(options?: {
  ...
  const lastRunMs =
    globalForDemoSimulator.__NFC_DEMO_SIM_LAST_RUN_MS__ ??
  ...
  globalForDemoSimulator.__NFC_DEMO_SIM_LAST_RUN_MS__ = nowMs
