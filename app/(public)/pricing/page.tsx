...
export default function PricingPage() {
  return (
    <div className="relative overflow-hidden px-4 py-6 md:px-6 md:py-8">
      ...
      <div
        aria-hidden="true"
        className="sales-orbit pointer-events-none absolute -right-24 top-[32%] -z-10 h-72 w-72 rounded-full brand-orb-navy blur-3xl [animation-delay:320ms]"
      />
      ...
      <div className="mx-auto max-w-[1200px] space-y-5">
        ...
        <div className="grid gap-4 xl:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
          ...
          <Card gradient={false} className="sales-reveal sales-delay-2 space-y-3 border-[rgba(0,18,88,0.34)] bg-[rgba(10,21,40,0.76)]">
            ...
            <div className="space-y-2 text-sm leading-6 text-[rgba(255,255,255,0.88)]">
              <p>
            ...
            <div className="rounded-[14px] border border-[rgba(0,18,88,0.28)] bg-[rgba(21,36,61,0.62)] px-3 py-3 text-xs text-[rgba(182,203,236,0.84)]">
          ...
          <Card gradient={false} className="sales-reveal sales-delay-4 space-y-3 border-[rgba(0,18,88,0.34)] bg-[rgba(10,21,40,0.76)]">
            ...
            <div className="space-y-2">
              {launchPhases.map(phase => (
                ...
                >
                  <div className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[rgba(217,174,63,0.9)]">
                    {phase.label}
                  </div>
