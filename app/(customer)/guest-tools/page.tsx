      ...
      <div className="mx-auto max-w-[980px] space-y-6">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <Card className="space-y-4">
            <h2 className="display-font text-xl font-semibold tracking-tight">Customer Account & Loyalty</h2>
            <input className="w-full rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={customerId} onChange={e => setCustomerId(e.target.value)} placeholder="Customer ID (optional)" />
            <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
              <input className="rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={name} onChange={e => setName(e.target.value)} placeholder="Name" />
              <input className="rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={phone} onChange={e => setPhone(e.target.value)} placeholder="Phone" />
            </div>
            <input className="w-full rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={email} onChange={e => setEmail(e.target.value)} placeholder="Email" />
          ...
          {showCard("promos") && (
          <Card className="space-y-4">
            <h2 className="display-font text-xl font-semibold tracking-tight">Active Promotions</h2>
            <div className="space-y-2">
              {promos.filter(p => p.active).map(promo => (
                <div key={promo.code} className="rounded-[var(--radius-control)] border border-[var(--border-subtle)] px-3 py-2 text-sm">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <Card className="space-y-4">
            <h2 className="display-font text-xl font-semibold tracking-tight">Reservation</h2>
            <input className="w-full rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={reservationName} onChange={e => setReservationName(e.target.value)} placeholder="Name" />
            <input className="w-full rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={reservationPhone} onChange={e => setReservationPhone(e.target.value)} placeholder="Phone" />
            <div className="grid grid-cols-2 gap-2">
              <input className="rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={reservationPartySize} onChange={e => setReservationPartySize(e.target.value)} placeholder="Party size" />
              <input type="datetime-local" className="rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={reservationFor} onChange={e => setReservationFor(e.target.value)} />
            </div>
          ...
          {showCard("waitlist") && (
          <Card className="space-y-4">
            <h2 className="display-font text-xl font-semibold tracking-tight">Join Waitlist</h2>
            <input className="w-full rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={waitName} onChange={e => setWaitName(e.target.value)} placeholder="Name" />
            <input className="w-full rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={waitPhone} onChange={e => setWaitPhone(e.target.value)} placeholder="Phone" />
            <input className="w-full rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={waitPartySize} onChange={e => setWaitPartySize(e.target.value)} placeholder="Party size" />
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {showCard("feedback") && (
          <Card className="space-y-4">
            <h2 className="display-font text-xl font-semibold tracking-tight">Feedback</h2>
            <div className="grid grid-cols-2 gap-2">
              <input className="rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={feedbackRating} onChange={e => setFeedbackRating(e.target.value)} placeholder="Rating 1-5" />
              <input className="rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={customerId} onChange={e => setCustomerId(e.target.value)} placeholder="Customer ID" />
            </div>
            <textarea className="min-h-[96px] w-full rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={feedbackComment} onChange={e => setFeedbackComment(e.target.value)} placeholder="Tell us about your visit" />
          ...
          <Card className="space-y-4">
            <h2 className="display-font text-xl font-semibold tracking-tight">Notifications</h2>
            <input className="w-full rounded-[var(--radius-control)] border input-premium border-[var(--border-subtle)] bg-transparent px-4 py-2.5 text-base" value={notificationRecipient} onChange={e => setNotificationRecipient(e.target.value)} placeholder="recipient (email:.. or session:..)" />
            ...
            <div className="max-h-[190px] space-y-2 overflow-y-auto pr-1">
              {notifications.map(item => (
                <div key={item.id} className="rounded-[var(--radius-control)] border border-[var(--border-subtle)] px-3 py-2 text-sm">
