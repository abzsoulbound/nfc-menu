...
const controlFieldClass =
  "rounded-[var(--radius-control)] border border-[rgba(0,18,88,0.34)] bg-[rgba(0,18,88,0.52)] px-3 py-2 text-sm text-[var(--text-primary)] outline-none transition-colors focus:border-[rgba(0,18,88,0.72)]"
    ...
    <div className="relative px-4 py-5 md:px-6 md:py-6">
      ...
      <div className="mx-auto max-w-[1480px] space-y-4">
          ...
          <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2 text-xs text-[rgba(203,221,247,0.92)]">
                <span className="rounded-full border border-[rgba(0,18,88,0.46)] bg-[rgba(0,18,88,0.52)] px-2 py-1">
        ...
        <div className="grid grid-cols-2 gap-2 md:grid-cols-4 xl:grid-cols-7">
          <Card className="border-[rgba(0,18,88,0.34)] bg-[rgba(0,18,88,0.72)]">
            <div className="text-[11px] uppercase tracking-[0.12em] text-[rgba(169,193,234,0.88)]">
              Reservations
            </div>
            <div className="mt-1 text-2xl font-semibold text-[#faf6ef]">
          ...
          <Card className="space-y-3 border-[rgba(0,18,88,0.34)] bg-[rgba(0,18,88,0.72)]">
            ...
            <div className="space-y-2">
              {promos.map(promo => (
                <div
                  key={promo.code}
                  className="flex flex-wrap items-center justify-between gap-2 rounded-[var(--radius-control)] border border-[rgba(0,18,88,0.32)] bg-[rgba(0,18,88,0.5)] px-3 py-2"
                >
                  <div className="text-sm">
                    <div className="font-semibold text-[#faf6ef]">
                      {promo.code} {promo.active ? "(active)" : "(inactive)"}
                    </div>
                    <div className="text-[rgba(255,255,255,0.76)]">
                      {promo.description}
                    </div>
                  </div>
                  <Button
              ...
              {promos.length === 0 ? (
                <div className="rounded-[var(--radius-control)] border border-[rgba(0,18,88,0.32)] bg-[rgba(0,18,88,0.4)] px-3 py-3 text-sm text-[rgba(255,255,255,0.76)]">
          ...
          <Card className="space-y-3 border-[rgba(0,18,88,0.34)] bg-[rgba(0,18,88,0.72)]">
            ...
            <div className="space-y-2">
              {dayparts.map(daypart => (
                ...
                >
                  <div className="text-sm">
                    <div className="font-semibold text-[#faf6ef]">{daypart.name}</div>
                    <div className="text-[rgba(255,255,255,0.76)]">
            ...
            <div className="flex flex-wrap items-center gap-2 border-t border-[rgba(0,18,88,0.26)] pt-3">
              <span className="text-sm text-[rgba(255,255,255,0.84)]">
                Low stock threshold
              </span>
              <input
        ...
        <div className="grid gap-4 xl:grid-cols-2">
          <Card className="space-y-3 border-[rgba(0,18,88,0.34)] bg-[rgba(0,18,88,0.72)]">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              <div className="space-y-2 rounded-[var(--radius-control)] border border-[rgba(0,18,88,0.3)] bg-[rgba(0,18,88,0.45)] p-3">
                ...
                <div className="max-h-[260px] space-y-2 overflow-y-auto pr-1">
                  {reservations.map(entry => (
                    <div
                      key={entry.id}
                      className="rounded-[var(--radius-control)] border border-[rgba(0,18,88,0.3)] bg-[rgba(0,18,88,0.72)] px-3 py-2 text-sm"
                    >
                      <div className="font-semibold text-[#faf6ef]">
                  ...
                  {reservations.length === 0 ? (
                    <div className="py-3 text-sm text-[rgba(255,255,255,0.74)]">
                      No reservations.
                    </div>
                  ) : null}
                </div>
              ...
              <div className="space-y-2 rounded-[var(--radius-control)] border border-[rgba(0,18,88,0.3)] bg-[rgba(0,18,88,0.45)] p-3">
                <div className="text-sm font-semibold text-[#faf6ef]">Waitlist</div>
                <div className="max-h-[260px] space-y-2 overflow-y-auto pr-1">
                  {waitlist.map(entry => (
                    <div
                      key={entry.id}
          ...
          <Card className="space-y-3 border-[rgba(0,18,88,0.34)] bg-[rgba(0,18,88,0.72)]">
            ...
            <div className="max-h-[280px] space-y-2 overflow-y-auto pr-1">
              {delivery.map(order => (
                <div
                  key={order.id}
                  className="flex flex-wrap items-center justify-between gap-2 rounded-[var(--radius-control)] border border-[rgba(0,18,88,0.3)] bg-[rgba(0,18,88,0.5)] px-3 py-2 text-sm"
                >
                  <div>
                    <div className="font-semibold text-[#faf6ef]">
        ...
        <div className="grid gap-4 xl:grid-cols-3">
          <Card className="space-y-2 border-[rgba(0,18,88,0.34)] bg-[rgba(0,18,88,0.72)]">
            <h3 className="text-base font-semibold tracking-tight text-[#faf6ef]">
              Loyalty Top
            </h3>
            <div className="max-h-[220px] space-y-1 overflow-y-auto pr-1">
              {loyalty.slice(0, 20).map(entry => (
                <div key={entry.customerId} className="text-sm">
                  ...
                  <span className="text-[rgba(255,255,255,0.76)]">
                    {" "}
        ...
        <Card className="space-y-3 border-[rgba(0,18,88,0.34)] bg-[rgba(0,18,88,0.72)]">
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <div className="text-xs text-[rgba(255,255,255,0.76)]">
          ...
          <div className="grid grid-cols-1 gap-2 md:grid-cols-4">
            ...
            />
            <label className="space-y-1 text-xs text-[rgba(255,255,255,0.76)] md:col-span-1">
              Traffic %
              <input
                className={controlFieldClass}
            ...
            <label className="space-y-1 text-xs text-[rgba(255,255,255,0.76)] md:col-span-3">
              Variant JSON
              <textarea
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <label className="flex items-center gap-2 text-xs text-[rgba(255,255,255,0.76)]">
              Insights days
              <input
                className={`${controlFieldClass} w-24 px-2 py-1`}
          ...
          <div className="grid gap-3 lg:grid-cols-2">
            <div className="rounded-[var(--radius-control)] border border-[rgba(0,18,88,0.3)] bg-[rgba(0,18,88,0.45)] p-3">
              <div className="text-xs font-semibold uppercase tracking-[0.12em] text-[rgba(255,255,255,0.76)]">
                Experiment list
              </div>
              <div className="mt-2 max-h-[220px] space-y-1 overflow-y-auto pr-1 text-sm text-[rgba(255,255,255,0.82)]">
            ...
            <div className="rounded-[var(--radius-control)] border border-[rgba(0,18,88,0.3)] bg-[rgba(0,18,88,0.45)] p-3">
              ...
              {uxInsights ? (
                <div className="mt-2 space-y-2 text-sm text-[rgba(255,255,255,0.82)]">
                  <div>
                  ...
                  <div className="max-h-[180px] space-y-2 overflow-y-auto pr-1">
                    {uxInsights.variants.map(variant => (
                      <div
                        ...
                        className="rounded-[var(--radius-control)] border border-[rgba(0,18,88,0.3)] bg-[rgba(0,18,88,0.72)] px-3 py-2"
                      >
                        <div className="font-semibold text-[#faf6ef]">
                ...
                <div className="mt-2 text-sm text-[rgba(255,255,255,0.74)]">
        ...
        <Card className="space-y-2 border-[rgba(0,18,88,0.34)] bg-[rgba(0,18,88,0.72)]">
          ...
          <div className="max-h-[240px] space-y-1 overflow-y-auto pr-1 text-sm text-[rgba(255,255,255,0.82)]">
            {receipts.map(entry => (
            ...
            {receipts.length === 0 ? (
              <div className="py-3 text-[rgba(255,255,255,0.74)]">
                No receipts yet.
              </div>
            ) : null}
          </div>
